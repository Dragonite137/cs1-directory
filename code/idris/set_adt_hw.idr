...
combine l1 nil = l1
combine nil l2 = l2
combine (h1::t1) (h2::t2) = ite (member h1 (h2::t2)) (combine t1 (h2::t2)) (h1::(combine t1 (h2::t2)))
...
list_difference (h1::t1) l2 = ite (member h1 l2) (list_difference t1 l2) (h1::(list_difference t1 l2)) 
...
set_exists p (mkSet (h::t)) = ite (p h) (true) (set_exists p (mkSet t))
...
--pair elt takes an element h and a list b and returns a list of all
--pairs, (h, e), where e is an element of the list b
pairElt: a -> list b -> list (pair a b)
pairElt someA nil = nil
pairElt someA (h::t) = (mkPair someA h)::(pairElt someA t)
